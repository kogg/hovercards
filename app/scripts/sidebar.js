    ...
    function sendMessage(message) {
        ...
        switch (message.msg) {
            case 'load':
                ...
                chrome.runtime.sendMessage({ type: 'analytics', request: ['send', 'event', 'sidebar', 'activated ' + message.by, (message.identity.api || 'none') + ' ' + message.identity.type, { page: '/' + window.top.document.URL }] });
