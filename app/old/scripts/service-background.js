...
var initialize_client_callers = {
    instagram: function(callback) {
        chrome.storage.sync.get('instagram_user', function(obj) {
            ...
            return callback(null, require('hovercardsshared/apis/instagram')({ user: obj.instagram_user }));
        });
    },
    reddit: function(callback) {
        async.waterfall([
            ...
            function(device_id, callback) {
                callback(null, require('hovercardsshared/apis/reddit')({ key: REDDIT_KEY, device: device_id }));
            }
        ], callback);
    },
    soundcloud: function(callback) {
        callback(null, require('hovercardsshared/apis/soundcloud')({ key: SOUNDCLOUD_KEY }));
    }
};
