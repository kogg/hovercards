...
module.exports = React.createClass({
	...
	render: function() {
		...
		if (this.props.content.err) {
			return <Err className={className} error={this.props.content.err} authenticate={this.props.authenticate} getEntity={this.props.getEntity} />;
		}
		...
		return (
			<div className={className}>
				...
				<Discussions content={this.props.content} authenticate={this.props.authenticate} getEntity={this.props.getEntity} onResize={this.props.onResize} />
			</div>
		);
	}
});
